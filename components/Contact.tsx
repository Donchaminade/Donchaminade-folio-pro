...
${message}`;
  ...
  return (
    <section id="contact" className="py-20 md:py-32 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
      <div>
        <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter leading-none mb-8 md:mb-10 text-slate-900 dark:text-white">Prêt pour le <br /><span className="text-blue-600 dark:text-blue-500">succès ?</span></h2>
        <p className="text-slate-600 dark:text-slate-300 text-lg md:text-2xl font-light leading-relaxed mb-10 md:mb-12">Parlons de vos idées. Je suis prêt à relever vos défis technologiques les plus ambitieux.</p>
        <address className="not-italic space-y-4 md:space-y-6">
          <div className="flex items-center gap-4 md:gap-6 text-slate-700 dark:text-slate-300 group/link">
            <div className="p-3 md:p-4 glass rounded-2xl text-blue-600 dark:text-blue-400 border-slate-200 dark:border-white/10 group-hover/link:bg-blue-100/50 dark:group-hover/link:bg-blue-500/10 group-hover/link:text-blue-700 dark:group-hover/link:text-blue-300 transition-all"><Mail size={20} /></div>
            <a href="mailto:chaminade.dondah.adjolou@gmail.com" className="text-base md:text-lg hover:text-blue-600 dark:hover:text-blue-500 transition-colors font-medium break-all">chaminade.dondah.adjolou@gmail.com</a>
          </div>
          <div className="flex items-center gap-4 md:gap-6 text-slate-700 dark:text-slate-300 group/link">
            <div className="p-3 md:p-4 glass rounded-2xl text-blue-600 dark:text-blue-500 border-slate-200 dark:border-white/10 group-hover/link:bg-blue-100/50 dark:group-hover/link:bg-blue-500/10 group-hover/link:text-blue-700 dark:group-hover/link:text-blue-300 transition-all"><Phone size={20} /></div>
            <a href="tel:+22899181626" className="text-base md:text-lg hover:text-blue-600 dark:hover:text-blue-500 transition-colors font-medium">+228 99 18 16 26</a>
          </div>
        </address>
      </div>
        ...
        <form className="space-y-6 md:space-y-8" onSubmit={handleContactSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-slate-100/50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl px-6 py-3 md:py-4 text-sm focus:outline-none focus:border-blue-500 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-700 transition-all"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full bg-slate-100/50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl px-6 py-3 md:py-4 text-sm focus:outline-none focus:border-blue-500 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-700 resize-none transition-all"
