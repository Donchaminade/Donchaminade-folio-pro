  ...
  <AnimatePresence>
    {project && (
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8 bg-slate-100/98 dark:bg-slate-950/98 backdrop-blur-2xl overflow-y-auto"
        onClick={onClose}
      >
        <motion.div
          ...
          className="bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-white/10 rounded-[3rem] w-full max-w-6xl my-auto relative shadow-[0_40px_120px_rgba(0,0,0,0.1)] dark:shadow-[0_40px_120px_rgba(0,0,0,0.9)] overflow-hidden"
        ...
        >
          ...
          <div className="absolute top-6 right-6 flex gap-3 z-[60]">
            <button
              onClick={onClose}
              className="p-4 glass rounded-full text-slate-500 dark:text-white/50 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200/50 dark:hover:bg-white/10 transition-all border border-slate-200 dark:border-white/5 shadow-xl"
            >
              <X size={24} />
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            {/* Information Part */}
            <div className="lg:col-span-5 flex flex-col p-8 md:p-14 lg:p-16 h-full overflow-y-auto no-scrollbar bg-white/40 dark:bg-slate-900/40">
              ...
              <div className="mt-16 pt-12 border-t border-slate-200 dark:border-white/5 space-y-5">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  {project.github && project.github !== '#' && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 px-8 py-5 glass text-slate-900 dark:text-white font-black text-[11px] uppercase tracking-[0.2em] rounded-2xl flex items-center justify-center gap-3 hover:bg-slate-200/50 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 transition-all hover:scale-[1.02] active:scale-95 group"
                    >
                  ...
                  {(!project.github || project.github === '#') && (!project.link || project.link === '#') && (
                    <div className="flex-1 py-5 glass rounded-2xl text-slate-500 font-black text-[11px] uppercase tracking-widest border border-slate-200 dark:border-white/5 italic text-center">
