...
const CommunitySection: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8 max-w-6xl mx-auto items-stretch">
        {communities.map((comm, i) => (
          <GlassCard
            key={comm.name}
            className={`p-6 md:p-10 h-full cursor-pointer rounded-[2rem] md:rounded-[3rem] transition-all border-slate-200 dark:border-white/5 relative overflow-hidden group/card ${activeCommunity === i ? 'ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-500/10' : 'hover:bg-slate-200/50 dark:hover:bg-white/5 hover:-translate-y-1'}`}
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className="font-black text-slate-900 dark:text-white text-xl md:text-2xl uppercase tracking-tight leading-tight mb-4 break-words">{comm.name}</h3>
              ...
              <AnimatePresence>
                {activeCommunity === i && (
                  <motion.div
                    ...
                    className="text-sm md:text-base text-slate-600 dark:text-slate-400 mt-8 leading-relaxed overflow-hidden font-light"
                  >
