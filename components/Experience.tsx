      ...
      <div className="max-w-5xl mx-auto px-4 md:px-0">
        <div className="relative border-l-2 md:border-l-4 border-blue-500/20 ml-4 md:ml-12 space-y-12 md:space-y-20">
          {EXPERIENCES.map((exp, i) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute -left-[11px] md:-left-[18px] top-6 md:top-8 w-5 h-5 md:w-8 md:h-8 rounded-full bg-slate-50 dark:bg-slate-950 border-4 border-blue-500 flex items-center justify-center p-1 md:p-1.5 shadow-[0_0_20px_rgba(59,130,246,0.3)] dark:shadow-[0_0_20px_rgba(59,130,246,0.5)] group-hover:scale-125 group-hover:bg-blue-500 transition-all duration-300">
                <div className="w-full h-full rounded-full bg-blue-400 group-hover:bg-white animate-pulse" />
              </div>

              <GlassCard className="p-6 md:p-10 border-slate-200 dark:border-white/5 hover:border-blue-500/40 hover:bg-slate-200/50 dark:hover:bg-white/[0.02] transition-all rounded-3xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <ul className="space-y-4 mb-8">
                    {exp.description.map((item, j) => (
                      <li key={j} className="text-sm md:text-base text-slate-600 dark:text-slate-400 leading-relaxed font-light flex gap-4 items-start group/item">
